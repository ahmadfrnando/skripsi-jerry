...
<body class="">
          ...
          <div class="row align-items-center">
            <div class="col-lg order-lg-first">
              <ul class="nav nav-tabs border-0 flex-column flex-lg-row">
                ...
                <li class="nav-item">
                  <a href="{{route('admin.user')}}" class='nav-link {{ request()->segment(2) == 'user' ? 'active' : '' }}'>
                ...
                <li class="nav-item">
                  <a href="{{route('admin.gaun')}} " class="nav-link {{ request()->segment(2) == 'gaun' ? 'active' : '' }}">
                    <i class='fe fe-list'></i>
                    Gaun
                  </a>
                </li>
                <li class="nav-item">
                  <a href="{{route('admin.pemesanan')}} " class="nav-link {{ request()->segment(2) == 'pemesanan' ? 'active' : '' }}">
                    <i class='fe fe-list'></i>
                    Pemesanan
                  </a>
                </li>
                ...
                <!-- <li class="nav-item">
                  <a href="{{route('admin.review')}}" class="nav-link {{ request()->segment(2) == 'review' ? 'active' : '' }}">
                ...
                <li class='nav-item'>
                  <a href="{{route('admin.invoice')}}" class='nav-link {{ request()->segment(2) == 'invoice' ? 'active' : '' }}'>
                ...
                <li class="nav-item">
                  <a href="{{route('admin.report')}}" class='nav-link {{ request()->segment(2) == 'report' ? 'active' : '' }}'>
  ...
  <script>
    ...
    //   comeback ")["
    //   failed "]}}", "");
    toastr.success("{{Session::get('comeback') ? Session::get('comeback')['failed'] : ''}}", "");
  </script>
  @endif

  @if(Session::get("comeback")["message"] == "success")
  <script>
    toastr.success("{{Session::get('comeback') ? Session::get('comeback')['success'] : ''}}", "");
  </script>
  @endif
  @endif
