								...
								<div class="table-responsive">
									<table class="table table-borderless">
										<tr>
											<td>Nama Gaun</td>
											<td>
												<a href="{{url('admin/product?search='.$invoice->product->nama_gaun)}}"
													target="_blank">
													{{$invoice->product->nama_gaun}}
												</a>
											</td>
										</tr>
										<tr>
											<td>Harga</td>
											<td>Rp.{{number_format($invoice->product->harga,2)}} Perhari</td>
										</tr>
										<tr>
											<td>Status</td>
											<td>
